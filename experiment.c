...
const int TON_FIRST_PULSE = 3;      // a   corresponding to c
const int TON_INCREMENT = 8;        // b   corresponding to h
const int SYNC_PULSE_ON_TIME = 50;  
const int IDLE_TIME = 13;           // d   corresponding to n
...
void loop() {
  ...
  bool outputEnablePressed = digitalRead(OUTPUT_ENABLE_PIN) == HIGH;
